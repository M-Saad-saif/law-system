...
/**
 * Extracts structured 7-section summary from raw judgement text.
 * Follows the exact PRD schema for the AI Judgement Extractor module.
 *
 * @param {string} rawText - Raw pasted or extracted judgement text.
...
- Return ONLY the JSON object. No markdown code blocks. No explanation.`;
  ...
  try {
    const raw = await callAI(systemPrompt, `Extract from this judgement:\n\n${rawText.slice(0, 12000)}`);
