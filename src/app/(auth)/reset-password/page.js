        ...
        <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          {success ? (
            <div className="text-center">
              ...
              <Link
                href="/login"
                className="inline-flex items-center justify-center px-5 py-2.5 rounded-lg bg-[#027f7e] text-white font-semibold text-sm hover:bg-[#026a69] transition-colors"
              >
                Go to Sign In
              </Link>
            </div>
            ...
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-12 h-12 rounded-full bg-red-400/10 mb-4">
