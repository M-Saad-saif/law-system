    ...
    <section className="bg-white py-24 md:py-28" data-testid="pricing-teaser-section">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mt-10">
          <Link href="/pricing" data-testid="view-pricing-btn" className="inline-block px-8 py-3.5 bg-[#eef5f3] text-[#0f7e75] font-semibold rounded-full hover:bg-[#0f7e75] hover:text-white transition-all duration-300">
            View Full Pricing →
          </Link>
        </div>
      </div>
