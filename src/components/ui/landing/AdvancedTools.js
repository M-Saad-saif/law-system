...
const tools = [
  {
    ...
    desc: "Paste a judgment → get a clean 7-section summary.",
  },
  {
    icon: BookMarked,
    title: "Judgment Library",
    desc: "Save, tag and pin important judgments. Share with your team.",
  },
  {
    icon: MessageSquareText,
    title: "Cross-Exam Review",
    desc: "Junior drafts. Senior reviews. Everything tracked.",
  },
  {
    icon: Image,
    title: "Judgment Image Generator",
    desc: "Branded judgment cards. Export PNG / JPG.",
  },
];
...
export default function AdvancedTools() {
  return (
    <section
      className="bg-[#053433] py-24 md:py-28 relative overflow-hidden noise-overlay"
      data-testid="advanced-tools-section"
    >
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-[0.25em] text-[#8fe3d8] mb-4">
            Advanced Tools
          </p>
          <h2
            className="font-heading text-4xl md:text-5xl font-bold text-white tracking-tight"
            data-testid="advanced-tools-heading"
          >
            Work smarter,{" "}
            <span className="italic text-[#8fe3d8]">not longer.</span>
          </h2>
        </motion.div>
        ...
        >
          <div className="glass-dark rounded-3xl p-2.5 shadow-2xl shadow-black/40">
            <img
              src={SHOT_CROSSEXAM}
              alt="Cross-examination review workflow"
              className="w-full rounded-2xl block"
              loading="lazy"
              data-testid="crossexam-screenshot"
            />
          </div>
          <div className="glass-dark rounded-3xl p-2.5 shadow-2xl shadow-black/40">
            <img
              ...
              className="w-full rounded-2xl block"
              loading="lazy"
              data-testid="library-screenshot"
            />
          </div>
        </motion.div>
      </div>
